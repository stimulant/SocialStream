...
{
    /// <summary>
    /// Given a list of values, return visible if any of those values passes VisibilityConverter. Pass any parameter to return visible if no values pass.
    /// </summary>
    internal class MultiVisibilityConverter : IMultiValueConverter
    {
        /// <summary>
        /// An internal VisibilityConverter to do the actual conversion.
        /// </summary>
