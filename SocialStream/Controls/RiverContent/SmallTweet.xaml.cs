...
{
    /// <summary>
    /// A river item which shows the small version of tweet feed items.
    /// </summary>
    public partial class SmallTweet : UserControl
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SmallTweet"/> class.
        /// </summary>
        public SmallTweet()
        {
            InitializeComponent();
        ...
        /// </summary>
        public static readonly DependencyProperty IsPressedProperty = DependencyProperty.Register("IsPressed", typeof(bool), typeof(SmallTweet), new PropertyMetadata(false, IsPressedPropertyChanged));
        ...
        {
            (sender as SmallTweet).UpdateIsPressed();
        }
