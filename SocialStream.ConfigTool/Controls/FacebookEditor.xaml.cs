...
{
    /// <summary>
    /// Interaction logic for FacebookEditor.xaml
    /// </summary>
    public partial class FacebookEditor : UserControl
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="FacebookEditor"/> class.
        /// </summary>
        public FacebookEditor()
        {
            InitializeComponent();
        }
        ...
        {
            RemoveFacebookQueryCommand.Execute((sender as Button).DataContext as BindableStringVO);
        }
        ...
        {
            RemoveFacebookBanCommand.Execute((sender as Button).DataContext as BindableStringVO);
        }
        ...
        {
            _JustAdded = true;
            AddFacebookQueryCommand.Execute();
        }
        ...
        private void Radio_Checked(object sender, RoutedEventArgs e)
        {
            ...
            SetDisplayFbContentFromOthersCommand.Execute(bool.Parse(radio.Tag.ToString()));
        }
    }
}
